...
CREATE TRIGGER SWM_ROLE_BI_TR
BEFORE INSERT ON SWM_ROLE
FOR EACH ROW
...
(
    RESOURCE_ID          FLOAT(2,0)              NOT NULL,
...
CREATE TRIGGER SWM_RESOURCE_BI_TR
BEFORE INSERT ON SWM_RESOURCE
FOR EACH ROW
SET NEW.RECORD_DATE = NOW();
...
(
    USER_STATE_ID        FLOAT(2,0)              NOT NULL,
...
CREATE TRIGGER SWM_USER_BI_TR
BEFORE INSERT ON SWM_USER
FOR EACH ROW
SET NEW.RECORD_DATE = NOW();
...
(
    CONN_IDENTI_ID       FLOAT(2,0)              NOT NULL,
...
(
    CONN_TYPE_ID         FLOAT(2,0)              NOT NULL,
...
(
    CONN_TYPE_ID         FLOAT(3,0)              NOT NULL,
    CONN_IDENTI_ID       FLOAT(2,0)              NOT NULL,
...
(
    USER_CONN_ID         FLOAT(6,0)              NOT NULL,
    CONN_TYPE_ID         FLOAT(3,0)              NOT NULL,
    USER_ID              FLOAT(4,0)              NOT NULL,
...
INSERT INTO SWM_USER (USER_ID, USERNAME, USER_STATE_ID, USER_PASSWORD, EMAIL)
VALUES (1, 'admin', 2, '$2y$10$6b/9w1L5GPdnpXT2NpdNIe/b4SzYJ9gfRaOYP2xUXWbZ3ekR1GyHi', 'admin@localhost');

INSERT INTO SWM_USER_ROLE (USER_ID, ROLE_ID) VALUES (1, 2);