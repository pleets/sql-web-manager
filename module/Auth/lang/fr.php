...
return [
    ...
    "User registering" => "Enregistrement",
    ...
    "Successfully log in" => "Connexion réussie",
    "Username or password are incorrect" => "Nom d'utilisateur ou mot de passe incorrect",
    "Please wait a few seconds while we redirect you" => "S'il vous plaît attendez quelques secondes pendant que nous vous redirigeons",
    ...
    "Error trying to send email checking. Try it again later" => "Erreur lors de l'envoi d'une vérification par e-mail. Essayez-le à nouveau plus tard",
    "User pending of email checking" => "Utilisateur en attente de vérification par e-mail"
];
